  ...
  return (
    <div className="max-w-6xl mx-auto px-8">
      ...
      <div className="text-center mb-20 py-16">
        <h1 className="text-6xl font-bold mb-8">Welcome to Taylor Arndt</h1>
        <p className="text-2xl text-slate-400 max-w-4xl mx-auto leading-relaxed mb-12">
        ...
        <div className="flex justify-center gap-6">
          ...
          <a 
            href="/contact" 
            className="inline-flex items-center gap-3 border border-slate-600 hover:border-slate-500 text-white px-8 py-4 rounded-lg font-medium transition-colors text-lg"
          >
            Get In Touch
          </a>
        </div>
      ...
      <div className="mt-24 mb-16">
        ...
        <div className="grid lg:grid-cols-3 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          <div className="bg-slate-800 rounded-xl p-8 hover:bg-slate-700 transition-colors text-center">
            <div className="w-16 h-16 bg-green-600 rounded-xl mb-6 flex items-center justify-center mx-auto">
            </div>
            <h3 className="text-xl font-semibold mb-4">About Taylor</h3>
            <p className="text-slate-400 leading-relaxed">Learn about Taylor's background, expertise, and professional journey in detail.</p>
          </div>
          
          <div className="bg-slate-800 rounded-xl p-8 hover:bg-slate-700 transition-colors text-center">
            <div className="w-16 h-16 bg-purple-600 rounded-xl mb-6 flex items-center justify-center mx-auto">
            </div>
            <h3 className="text-xl font-semibold mb-4">Media & Appearances</h3>
            <p className="text-slate-400 leading-relaxed">Check out podcasts, interviews, and media appearances featuring Taylor.</p>
          </div>
          ...
          <div className="bg-slate-800 rounded-xl p-8 hover:bg-slate-700 transition-colors text-center">
            ...
            <p className="text-slate-400 leading-relaxed">Access curated resources, tools, and helpful links from Taylor.</p>
          </div>
        </div>
      </div>
    </div>
